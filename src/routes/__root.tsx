  ...
  head: () => ({
    meta: [
      ...
      { title: "Start Here | Redbelly DAO Onboarding Hub" },
      {
        name: "description",
        content:
          "Redbelly DAO onboarding: scam warning, KYC, network setup, wallet balance fixes, where to trade, staking and the testnet faucet.",
      },
      { property: "og:title", content: "Start Here | Redbelly DAO Onboarding Hub" },
      {
        property: "og:description",
        content:
          "Everything a new Redbelly DAO member needs in one page: KYC, chain IDs, RPC URLs, staking and the testnet faucet.",
      },
